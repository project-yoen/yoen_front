...
class PaymentUserDialog extends ConsumerStatefulWidget {
  final int travelId;

  const PaymentUserDialog({super.key, required this.travelId});

  @override
  ConsumerState<PaymentUserDialog> createState() => _PaymentUserDialogState();
}

class _PaymentUserDialogState extends ConsumerState<PaymentUserDialog> {
